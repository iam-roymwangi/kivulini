...
const slides = [
    { src: '/assets/images/hero.jpg', caption: 'Life is Short.', accent: 'Make it Epic.', sub: 'Curated road trips and live events for the bold.' },
    { src: '/assets/images/event-2.jpg', caption: 'No Tourist Traps.', accent: 'Real Adventures.', sub: 'Handpicked locations, unforgettable crew.' },
